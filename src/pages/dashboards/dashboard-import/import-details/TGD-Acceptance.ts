...
@Component({
  selector: 'TGD-Acceptance',
  templateUrl: 'TGD-Acceptance.html'
})
export class TGDAcceptance implements OnInit {
  ...
  TDGStatus: any;
  _pi_strTDGDetails: any;
  _pi_blnAmendment: any;
  _pi_blnXRAYAmendment: any;
  _pi_strPkgDetails: string;
